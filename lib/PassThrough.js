...
ResponsePassThrough.prototype.WritableSidePrototype = ServerResponse;
...
ResponsePassThrough.prototype.ReadableSidePrototype = IncomingMessage;
...
ResponsePassThrough.prototype.pipe = function pipe(dst, opt){
	...
	Duplex.prototype.pipe.call(this, dst, opt);
	return dst;
};

ResponsePassThrough.prototype.pipeMessage = function pipeMessage(dst, opt){
	const index = this._headerPipes.indexOf(dst);
	if(index < 0) this._headerPipes.push(dst);
	// Send headers if flushHeaders has already been called
	if(this._header && dst.setHeader) this.pipeHeaders(dst);
...
ResponsePassThrough.prototype.unpipe = function unpipe(dst){
	...
	return Duplex.prototype.unpipe.call(this, dst);
};
